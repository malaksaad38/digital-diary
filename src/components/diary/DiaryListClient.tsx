...
import { Calendar, Loader2, RefreshCw, Search, X, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <>
          ...
          <div className="space-y-4">
            {paginatedEntries.map((entry: any) => (
              <Card
                key={entry.date}
                className={`border shadow-sm bg-card hover:shadow-md transition-all duration-200`}
              >
